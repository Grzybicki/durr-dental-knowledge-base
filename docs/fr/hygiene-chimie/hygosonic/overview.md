---
layout: default
title: "Hygosonic — Bac à ultrasons Dürr Dental pour nettoyage des instruments"
...
keywords: ["Hygosonic", "Dürr Dental", "bac ultrasons", "nettoyage instruments dentaires", "ID 213", "MD 555", "préparation manuelle instruments"]
lang: fr
canonical_url: https://grzybicki.github.io/durr-dental-knowledge-base/docs/fr/hygiene-chimie/hygosonic/overview/
permalink: /docs/fr/hygiene-chimie/hygosonic/overview/
...
source_documents:
  ...
  - title: "Page Hygosonic (DE)"
    ...
    type: "page produit"
    language: "de"
  - title: "Page Instrument reprocessing (EN)"
...
**Hygosonic** est le **bac à ultrasons** Dürr Dental dédié au
**nettoyage rapide et intense** des instruments dentaires en amont de la
stérilisation. Il s'inscrit dans la **chaîne de préparation manuelle**
des instruments du cabinet.
...
Hygosonic est conçu pour être utilisé avec les produits chimiques
...
L'utilisation combinée garantit la **désinfection sécurisée** et le
**nettoyage en une seule étape**.

## Place dans la chaîne d'hygiène
