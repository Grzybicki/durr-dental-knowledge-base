...
| **[Désinfection des instruments et des empreintes](desinfection-empreintes/overview/)** | ID 213 (concentré désinfectant aldéhyde-free pour instruments) + Hygojet (système clos automatisé pour empreintes) | Couleur **bleue** |
| **[Désinfection des systèmes d'aspiration](desinfection-aspiration/overview/)** | Orotol Plus, Orotol Plus pH 7 (sans aldéhyde, sans phénol, sans chlore actif, > 95 % biodégradable) | Couleur **rouge** |
| **[Désinfection des mains](desinfection-mains/overview/)** | HD 420 plus, nettoyage et entretien des mains, distributeurs universels | Couleur **jaune** |
