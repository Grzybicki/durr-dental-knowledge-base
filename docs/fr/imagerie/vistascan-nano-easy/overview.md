---
layout: default
title: "VistaScan Nano Easy — Scanner de plaques au phosphore (ultracompact)"
...
keywords: ["VistaScan Nano Easy", "Dürr Dental", "scanner plaque phosphore", "chairside ultracompact", "image plate scanner"]
lang: fr
canonical_url: https://grzybicki.github.io/durr-dental-knowledge-base/docs/fr/imagerie/vistascan-nano-easy/overview/
permalink: /docs/fr/imagerie/vistascan-nano-easy/overview/
...
breadcrumbs:
  ...
  - name: "VistaScan Nano Easy"
    url: /docs/fr/imagerie/vistascan-nano-easy/overview/
source_documents:
...
**VistaScan Nano Easy** est le **scanner de plaques au phosphore le plus
compact** de la gamme Dürr Dental. Il prend en charge les **tailles intraorales
0, 1 et 2** et est conçu pour une **installation au fauteuil**. Particularité :
le **scan et l'effacement** sont réalisés en **une seule étape**, ce qui
optimise la préparation pour l'acquisition suivante.
...
Cabinet exigu (ex. : nouveau cabinet, cabinet itinérant, second poste de
