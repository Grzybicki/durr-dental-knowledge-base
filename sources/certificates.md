---
layout: default
title: "Sources — Certificats et conformité réglementaire"
description: "Index des Déclarations de Conformité publiques et références Eudamed des produits Dürr Dental."
lang: fr
...
Déclarations de Conformité (DoC) publiques et entrées Eudamed des dispositifs médicaux Dürr Dental
cités dans ce dépôt.
...
| Produit | Classe | Réglementation | Notified Body | Numéro de certificat | Date DoC |
|---|---|---|---|---|---|
| VistaPano S 2.0 / Ceph 2.0 | IIb | MDD 93/42/EEC (Annexe 9, Règle 10), transitioned MDR EU 2017/745 | DNV Product Assurance AS (code 2460) | 10877-2017-CE-KOR-NA-PS Rev 3.0 | 2024-01-29 |

### Comment retrouver la Déclaration de Conformité publique
...
- Recherche par fabricant dans Eudamed : <https://ec.europa.eu/tools/eudamed/screen/search?type=basicUDIInformation>

*Liste à compléter au fil de la publication des fiches produit.*
