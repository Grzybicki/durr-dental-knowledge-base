---
layout: default
title: "Sources — Certificats et conformité réglementaire (matrice MDR complète)"
...
# Sources — Certificats et conformité réglementaire

Matrice **MDR EU 2017/745** complète des produits Dürr Dental traités
dans ce dépôt. Les Déclarations de Conformité publiques détaillées sont
récupérables via le
...
ou la base [Eudamed](https://ec.europa.eu/tools/eudamed/screen/search?type=basicUDIInformation&deviceManufacturer=D%C3%BCrr+Dental).

## Bases régulatoires publiques

- **Eudamed** (UE — registre dispositifs médicaux MDR) :
...
|---|---|---|---|---|---|---|
| **VistaSoft 4.0** | **IIb** | MDR EU 2017/745 | DQS Medizinprodukte (0297) | 518373 MDR2017Q | À confirmer | [Fiche](/docs/fr/imagerie/vistasoft-4-0/overview/) |
| **VistaSoft AID** | **IIa** | MDR EU 2017/745 | DQS Medizinprodukte (0297) | À confirmer | À confirmer | [Fiche](/docs/fr/imagerie/vistasoft-aid/overview/) |
| **VistaSoft Trace** | À confirmer (probable IIa via socle Audax Ceph) | MDR EU 2017/745 | DQS Medizinprodukte (0297) | À confirmer | À confirmer | [Fiche](/docs/fr/imagerie/vistasoft-trace/overview/) |
| **VistaSoft Implant & Guide** | À confirmer (probable IIa) | MDR EU 2017/745 | DQS Medizinprodukte (0297) | À confirmer | À confirmer | [Fiche](/docs/fr/imagerie/vistasoft-implant-guide/overview/) |
| **VistaSoft Inspect** | À confirmer | MDR EU 2017/745 | DQS Medizinprodukte (0297) | À confirmer | À confirmer | [Fiche](/docs/fr/imagerie/vistasoft-inspect/overview/) |
| **VistaSoft Monitor** | **Non-DM** (IoT surveillance équipement) | — | — | — | — | [Fiche](/docs/fr/imagerie/vistasoft-monitor/overview/) |
| **VistaSoft Cloud View** | **Non-DM** (visualisation) | — | — | — | — | [Fiche](/docs/fr/imagerie/vistasoft-cloud-view/overview/) |
| **VistaSoft Cloud Exchange** | **Non-DM** (partage anonymisé RGPD) | — | — | — | — | [Fiche](/docs/fr/imagerie/vistasoft-cloud-exchange/overview/) |
| **VistaSoft Cloud Drive** | **Non-DM** (stockage cloud zero-knowledge) | — | — | — | — | [Fiche](/docs/fr/imagerie/vistasoft-cloud-drive/overview/) |
| **VistaSoft Mobile Connect** | **Non-DM** (consultation iPad) | — | — | — | — | [Fiche](/docs/fr/imagerie/vistasoft-mobile-connect/overview/) |
| **Patient Bridge** | À confirmer (interface logicielle, probable composant de VistaSoft 4.0 IIb) | MDR EU 2017/745 | DQS Medizinprodukte (0297) | À confirmer | À confirmer | [Fiche](/docs/fr/imagerie/patient-bridge/overview/) |
| **Image Bridge** | À confirmer (idem) | MDR EU 2017/745 | DQS Medizinprodukte (0297) | À confirmer | À confirmer | [Fiche](/docs/fr/imagerie/image-bridge/overview/) |

## Matrice MDR — Appareils d'imagerie

| Produit | Classe | Réglementation | Notified Body | N° certificat | Date DoC | Fiche |
|---|---|---|---|---|---|---|
| **VistaPano S 2.0 / VistaPano S Ceph 2.0** | **IIb** | MDD 93/42/EEC (Annexe 9, Règle 10), transitioned MDR EU 2017/745 | DNV Product Assurance AS (2460) | 10877-2017-CE-KOR-NA-PS Rev 3.0 | 2024-01-29 | [Fiche](/docs/fr/imagerie/vistapano-2-0/overview/) |
| **VistaVox S / VistaVox S Ceph** | **IIb** | MDR EU 2017/745 | À confirmer | À confirmer | À confirmer | [Fiche](/docs/fr/imagerie/vistavox-s/overview/) |
| **Gamme VistaScan** (Mini Easy 2.0, Mini View 2.0, Nano Easy, Combi View, Ultra View) | **IIa** | MDR EU 2017/745 | À confirmer | À confirmer | À confirmer | [Fiche](/docs/fr/imagerie/vistascan-gamme/overview/) |
| **VistaRay 7** | **IIa** | MDR EU 2017/745 | À confirmer | À confirmer | À confirmer | [Fiche](/docs/fr/imagerie/vistaray-7/overview/) |
| **VistaCam iX HD Smart** | **IIa** | MDR EU 2017/745 | À confirmer | À confirmer | À confirmer | [Fiche](/docs/fr/imagerie/vistacam-ix-hd-smart/overview/) |
| **VistaCam Proxi** (tête NIR 850 nm) | **IIa** | MDR EU 2017/745 | À confirmer | À confirmer | À confirmer | [Fiche](/docs/fr/imagerie/vistacam-proxi/overview/) |
| **VistaIntra DC** | **IIb** (générateur RX) | MDR EU 2017/745 | À confirmer | À confirmer | À confirmer | [Fiche](/docs/fr/imagerie/vistaintra-dc/overview/) |
...
| **Filtres HEPA / ULPA U16** | Composant — Norme EN 1822 / ISO 29463 | — | — | [Fiche](/docs/fr/conventionnel/filtres-hepa-ulpa-compresseurs/overview/) |

## Matrice MDR — Hygiène, parodontologie et chimie

| Produit | Classe | Réglementation | Fiche |
|---|---|---|---|
| **Lunos System** (MyLunos, MyLunos Duo, poudres, pâtes, fluor) | **IIa** (appareils) / I (consommables) | MDR EU 2017/745 | [Fiche](/docs/fr/hygiene-chimie/lunos-system/overview/) |
| **Vector Paro / Vector Paro Pro** | **IIa** | MDR EU 2017/745 | [Fiche](/docs/fr/hygiene-chimie/vector-paro/overview/) |
| **Hygoclave 40** | **IIa** | MDR EU 2017/745 + EN 13060 (stérilisateurs vapeur classe B) | [Fiche](/docs/fr/hygiene-chimie/hygoclave-hygopure/overview/) |
| **Hygoclave 50** | **IIa** | MDR EU 2017/745 + EN 13060 | [Fiche](/docs/fr/hygiene-chimie/hygoclave-hygopure/overview/) |
| **Hygoclave 90** | **IIa** | MDR EU 2017/745 + EN 13060 | [Fiche](/docs/fr/hygiene-chimie/hygoclave-hygopure/overview/) |
| **Hygopure 90 / Hygodem 90** (traitement d'eau pour stérilisateurs) | I (composant) | MDR EU 2017/745 | [Fiche](/docs/fr/hygiene-chimie/hygoclave-hygopure/overview/) |
| **Hygowater** (décontamination eau fauteuils) | **IIa** | MDR EU 2017/745 | [Fiche](/docs/fr/hygiene-chimie/hygowater-traitement-eau/overview/) |
| **Hygojet** (laveur-désinfecteur empreintes) | **IIa** | MDR EU 2017/745 | [Fiche](/docs/fr/hygiene-chimie/desinfection-empreintes/overview/) |
...
| **DIN 6868-157** | Contrôle qualité des dispositifs d'imagerie radiographique |
| **EN 1822-1:2019-10** | Filtres HEPA et ULPA — classification |
| **ISO 29463-3:2018** | Filtres HEPA et ULPA — classification internationale |
| **CEI 80001-1** | Gestion des risques liés aux réseaux IT intégrant des DM |
| **CEI 60336** | Foyers des tubes RX |
...
Pour récupérer une **Déclaration de Conformité** spécifique :
...
2. Rechercher le **nom du produit** + « Déclaration de Conformité » ou
   « DoC ».
3. Télécharger le PDF correspondant à la version installée du
   produit.

Alternativement, la recherche par fabricant dans
[Eudamed](https://ec.europa.eu/tools/eudamed/screen/search?type=basicUDIInformation&deviceManufacturer=D%C3%BCrr+Dental)
permet de retrouver les **UDI** et **classifications** des dispositifs
Dürr Dental publiés dans la base européenne.

---

*Cette matrice est une synthèse indépendante basée sur des sources publiques officielles
